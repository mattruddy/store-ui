      ...
      <IonContent>
        <IonGrid fixed>
          ...
          <IonRow style={styles.row}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <ul>
                ...
                <li>
                  Click the plus <IonIcon icon={addCircleOutline} /> on the
                  right side of the address bar (chrome only)
                </li>
              </ul>
            </div>
          </IonRow>
          ...
          <IonRow style={styles.row}>
            <p>
              {" "}
              We believe Progressive Web App's were how apps should have been
              all along. It gives the creators the freedom and flexability to
              build something that truly belongs to them without outside forces
              (Apple and Google) controlling the product and taking significant
              cuts for their hard work. This caused app stores to turn into a
              series of ads and in app purchases. PWA's are a nice fresh start
              to make apps enjoyable again. We really hope you enjoy using PWA's
              as much as we do!
            </p>
          </IonRow>
